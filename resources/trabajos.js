// resources/trabajos.js
// Trabajos de comunicación/documentales/reportajes organizados por municipio.
...
(function () {
    ...
    window.trabajos = {
        "AGUSTIN CODAZZI": [
            ...
            {
                titulo: "JUAIM, Café del Milagro",
                slogan: "ARIALDO JIMENEZ/CANAL 14",
                descripcion: "Este audiovisual busca mostrar que a pesar de la adversidad se puede lograr construir un emprendimiento que describe la diferencia entre un antes y un después, logrando transformar la violencia en bienestar para la comunidad y la sociedad.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/12.-PROYECTO-CAFE-JUAIM.png",
        ...
        "LA JAGUA DE IBIRICO": [
            {
                ...
                descripcion: "Desde la vereda San Isidro les mostramos un relato que resalta la biodiversidad del bosque seco tropical, la memoria representada en la antigua Mina La Escondida y la majestuosidad del Cerro Pinzón, símbolo del municipio.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/6-CANO-BLANCO-item-menu.png",
            ...
            {
                titulo: "La Jagua de Ibirico Historia de La Minería",
                slogan: "EL KUPER ON LINE – HUBER PEDROZA",
                descripcion: "",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/la-jagua-de-ibirico-historia-de-la-mineria.jpg",
        ...
        "EL PASO": [
            ...
            {
                titulo: "Así era la Loma Vieja",
                slogan: "MAYEISI MOLINA / La Loma Al Día",
                descripcion: "Este video nos presenta un emocionante contraste entre la Loma antigua y la Loma actual. A través de entrevistas a habitantes que vivieron la época de la vieja Loma, conocemos cómo eran sus tradiciones, sus costumbres y la vida de hace varios años atrás.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/12-LA-LOMA-VIEJA.-MAYEISI-MOLINA-item-menu.png",
                url: "https://colectivotejidosonoro.com/asi-era-la-loma-vieja/",
                tipo: "Individual"
            },
            {
                titulo: "Somos más que minería",
                slogan: "Activa Stereo",
                descripcion: "El proyecto audiovisual “La Loma: Tierra caliente, minera y vallenata” es un video sonoro tipo documental que busca resaltar la identidad cultural, social y económica de la población de La Loma de Calenturas, en el Cesar, Colombia.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/Somos-mas-que-mineria.png",
                url: "https://colectivotejidosonoro.com/somos-mas-que-mineria/",
                tipo: "Individual"
            }
        ],
        "CHIRIGUANA": [
            {
                ...
                descripcion: "Un recorrido sonoro por la belleza, cultura y tradición de Chiriguaná, corazón del Cesar. A través de una voz cálida y entusiasta, el oyente descubre un municipio lleno de vida, donde la naturaleza, la gastronomía, las fiestas y la hospitalidad de su gente se unen para ofrecer una experiencia única.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/2-CHIRIGUANA-TU-PROXIMO-DESTINO-item-menu.jpg",
                url: "https://colectivotejidosonoro.com/chiriguana-tu-proximo-destino/",
                tipo: "Colectivo"
            },
            {
                titulo: "Las Panochas de Rincón Hondo",
                slogan: "LUIS FERNANDEZ/Entérese, Noticias Chiriguaná",
                descripcion: "La panocha, más que un producto gastronómico, constituye un símbolo vivo de la identidad cultural de Rinconhondo. Su elaboración artesanal, transmitida de generación en generación, refleja la memoria colectiva de un pueblo que ha hecho de la tradición un acto de resistencia y orgullo.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/11-PANOCHA-ENTERESE-CHIRIGUANA-item-menu.png",
                url: "https://colectivotejidosonoro.com/las-panochas-de-rincon-hondo-cultura-y-tradicion/",
                tipo: "Colectivo"
            },
            {
                titulo: "Pescadores y problemática ambiental en la Ciénaga de Zapatosa en Chiriguaná",
                slogan: "LOLY BUSTAMANTE / La Voz de Chiriguaná",
                descripcion: "El testimonio de quienes viven y sobreviven con los productos generados por la Ciénaga Grande de Zapatosa, se expresa como un clamor sobre el daño ambiental causado a este ecosistema estratégico del Corredor de Vida del Cesar.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/Pescadores-y-problematica-ambiental-.png",
                url: "https://colectivotejidosonoro.com/pescadores-y-problematica-ambiental-en-la-cienaga-de-zapatosa-de-chiriguana/",
                tipo: "Individual"
            },
            {
        ...
        "CHIMICHAGUA": [
            {
                ...
                descripcion: "La Ciénaga de Zapatosa es un espejo de vida que refleja una lucha silenciosa. Sus aguas, antes cristalinas y abundantes, hoy muestran señales de agotamiento. La contaminación y la actividad minera amenazan su pureza y su futuro. Entre los juncos y el murmullo del viento, se siente el suspiro de un ecosistema que pide auxilio, pero también el latido firme de una comunidad que no se rinde.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/13-la-zapatosa-resiste-item-menu.png",
                url: "https://colectivotejidosonoro.com/la-zapatosa-resiste/",
                tipo: "Colectivo"
            },
            {
                titulo: "Artes Sanas",
                slogan: "JUAN FERNANDO JIMÉNEZ CORREA/Colectivo: CREA Chimichagua",
                descripcion: "El documental retrata la vida y resistencia de las artesanas de Candelaria, comunidad anfibia del sur del Cesar, que elaboran sus piezas con palma de estera, una especie en riesgo de extinción.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/8-Artes-Sanas-Candelaria-item-menu.png",
        ...
        "EL BANCO": [
            {
                ...
                descripcion: "“Los Sueños de Andrés Martínez” es una historia sobre la memoria, la conciencia ambiental y el profundo amor de un hombre por su territorio.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/Los-Suenos-de-Andres-Martinez.png",
                url: "https://colectivotejidosonoro.com/los-suenos-de-andres-martinez/",
                tipo: "Colectivo"
            },
            {
                titulo: "Guardiana De La Zapatosa",
                slogan: "MARTIN ESPAÑA / Colectivo: Kuré Escuela de Producción Audiovisual.",
                descripcion: "Guardiana de la Zapatosa es un documental que revela la vida de Carmen Ligia, una mujer que ha consagrado su existencia a cuidar y preservar la Ciénaga de la Zapatosa, un ecosistema sagrado para las comunidades ribereñas del Caribe colombiano.",
                thumbnail: "https://colectivotejidosonoro.com/wp-content/uploads/2025/11/7-guardiana-zapatosa-item-menu.png",
                url: "https://colectivotejidosonoro.com/guardiana-de-la-zapatosa/",
                tipo: "Individual"
            }
        ]
    };
    ...
    // Devuelve trabajos filtrados por Feature + búsqueda opcional
    window.getTrabajosForFeature = function (props, searchText = "") {

        const territorioIdent = props.MPIO_CNMBR || props.nombre || props.title;
        const trabajosTerritorio = window.trabajos[territorioIdent] || [];

        if (!searchText || searchText.trim() === "") {
            return trabajosTerritorio;
        }

        const query = normalize(searchText.trim());

        return trabajosTerritorio.filter(t => {
            return (
                normalize(t.titulo).includes(query) ||
                normalize(t.slogan).includes(query) ||
                normalize(t.descripcion).includes(query)
            );
        });
    };
